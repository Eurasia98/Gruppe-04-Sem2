...
public class CreateSysAdminScreenController implements Initializable {
    ...
    private void btnCreateActionHandler(ActionEvent event) {
        if (App.getCreditSystem().availableUsername(txtFieldUsername.getText()) && pwField.getText().equals(pwField2.getText())){
            if (App.getCreditSystem().createSpecialAccount(txtFieldUsername.getText(), pwField.getText(), "SystemAdministrator")){
